    ...
    return (
                    ...
                    <>   
                        <div className='flex flex-row bg-black  text-white w-[610px] ml-[500px] mt-6  rounded-full font-semibold p-5 justify-end text-[15px]'>
                            ...
                            <div className=' flex flex-row space-x-3'>
                               ...
                               <div className=' cursor-pointer hover:bg-blue-800 rounded-md p-2'
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8 text-left">
          ...
          <p className="text-lg ">Join the countless users who rely on [Your Website Name] to simplify their online learning journey. Begin exploring our features today and unlock the potential of YouTube videos as powerful study aids.</p>
        </div>
      </div>
    </div>
                ...
                : (
                    <>
                       <div className='flex flex-row bg-black justify-center  text-white w-[610px] ml-[500px] mt-6  rounded-full font-semibold p-5  text-[20px]'>
                                                        
                            <div className=' flex flex-row  '>
                            <Link to="/register">
                                <div className=" hover:bg-blue-800 rounded-lg cursor-pointer  p-2">Register</div>
                                </Link>
                                <Link to="/login">
                               <div className=' cursor-pointer hover:bg-blue-800 rounded-lg p-2'>Login</div>
                               </Link>
                                </div>
                        ...
                        <div className=' font-semibold text-center  text-[40px] text-black'>
