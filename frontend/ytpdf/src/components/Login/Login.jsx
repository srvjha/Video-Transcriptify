...
const Login = () => {
    ...
    envURL = envNode.url;
        ...
        axios
            .post(`${envURL}/api/v1/users/login`, {
                ...
                <div className=" flex flex-row  mx-auto md:h-screen lg:py-0 md:justify-center overflow-hidden">
                    ...
                    <div className="w-[760px] bg-white flex items-center justify-center  ">
                        <div className="p-6  flex flex-col items-center justify-center space-y-2 md:space-y-4 sm:p-8  w-[550px]">
                            ...
                            Welcome to <span className='font-semibold text-gray-700'>Video Transcriptify</span>, so happy to see you!
                            </div>
                            ...
                            <form className="space-y-4 md:space-y-6  w-[400px] p-2" action="#">
                                <div>
                                    ...
                                    <input type="email" name="email" value={email} onChange={(e) => setEmail(e.target.value)} id="email" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg text-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="name@company.com" required />
                                </div>
                                <div>
                                ...
                                focus:border-primary-600 w-full -mr-10 p-2.5" required />
                                ...
                                <p className="text-sm font-light text-gray-900 ">
                                    ...
                                    <Link to="/register" className="font-medium ml-1 text-primary-600 hover:underline dark:text-black">Sign up</Link>
                                </p>
                            </form>
                        </div>
                    </div>
